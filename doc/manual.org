...
#+language: en
#+export_file_name: mc.texi
#+texinfo_dir_category: Emacs
#+texinfo_dir_title: Master of Ceremonies: (mc).
...
~mc-focus-base-buffer~ exists when the current buffer is an =MC Focus= buffer and
#+begin_src elisp
  ;; Add this to your use-package :config section
  (defun my-screenshots-dir ()
    (interactive)
    (let ((dir (or (and mc-focus-base-buffer
                        (buffer-local-boundp
                         'mc--screenshot-dir mc-focus-base-buffer
                         (buffer-local-value
                          'mc--screenshot-dir mc-focus-base-buffer)))
                   (expand-file-name
                    "screenshots/"
      ...
      (when mc-focus-base-buffer (set-buffer mc-focus-base-buffer))
      (setq-local mc--screenshot-dir dir)))
